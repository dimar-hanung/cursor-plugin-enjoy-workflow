...
description: Think from first principles before executing; break broad questions into foundational ones. Not for listing creative options or names — use /brainstorm for that.
---
...
| Ask | Use |
|-----|-----|
| Options, names, compare approaches, creative directions | `/brainstorm` — no explore/research loop |
